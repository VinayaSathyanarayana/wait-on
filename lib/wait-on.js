...
// using lodash instead of lodash/fp until https://github.com/lodash/lodash/issues/4848 is fixed
const { isBoolean, isEmpty, negate, noop, once, partial: lodashPartial, pick: lodashPick, zip } = require('lodash'); // TODO reset this back to lodash/fp after fix is in for missing fp
// make pick use same lodash/fp style args, needed since lodash/fp is missing
const pick = (paths, object) => lodashPick(object, paths);
// make partial use lodash/fp style args, needed since lodash/fp is missing
const partial = (func, partials) => lodashPartial(func, ...partials);
